...
<body>
    ...
    <footer class="bg-dark flex-grow-0  text-center text-white w-100">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                <!-- Instagram -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/crowdvolley.it/"
                    role="button"><i class="fab fa-instagram"></i></a>

                <!-- Linkedin -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/crowdvolley/"
