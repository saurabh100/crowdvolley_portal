<div class="sidebar" id="sidebar">
    <div class="sidebar_section">
        ...
        <ul class="list-unstyled mb-5">
            ...
            {{-- Salary Structure --}}
            {{--<li class="sidebar-list-item  "><a class="sidebar-link text-muted" href="{{ route('salary.create.form') }}"><i class="fa-solid fa-dollar-sign me-2 text-info"></i>
            ...
            {{-- Task --}}
            {{-- <li class="sidebar-list-item  "><a class="sidebar-link text-muted " href="#"><i
                    class="fa-solid fa-list-check me-2 text-info"></i>
                <span class="sidebar-link-title fs-5">Manage Task</span></a>
        </li> --}}

            {{-- Manage Leave --}}
            <li class="sidebar-list-item  "><a class="sidebar-link text-muted " href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"><i class="fa-solid fa-person-walking-arrow-right me-2 text-info"></i>
            ...
            @endemployee
            {{-- Payroll --}}
            <li class="sidebar-list-item "><a class="sidebar-link text-muted " href="#" data-bs-target="#e-commerceDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"><i class="fa-solid fa-file-invoice-dollar me-2 text-info"></i>
            ...
            @admin
                <li class="list-unstyled">
                    <a class="sidebar-link text-muted {{ Request::segment(1) == 'PayrollList' ? 'active' : '' }}" href="{{ route('payroll.view') }}">
            ...
            {{-- Users --}}
            <li class="sidebar-list-item "><a class="sidebar-link text-muted " href="{{ route('users.list') }}"><i class="fa-solid fa-circle-user me-2 text-info"></i>
                    <span class="sidebar-link-title fs-5">Users</span></a>
            </li>
            @endadmin

            {{-- Notice --}}
            <li class="sidebar-list-item "><a class="sidebar-link text-muted" href="{{ route('show.notice') }}"><i class="fa-solid fa-check me-2 text-info"></i>
